...
variant {
	vertex {
		...
		source %{
			float echelle_texture_bruit_ondes=150.;
	...
	pixel {
		source %{
			...
			float vitesse_ondes_0=-20.;
			float quantite_ondes_0=0.025;
			float frequence_ondes_0=0.0005;
			float amplitude_ondes_0=4000.;
			float intensite_ondes_0=0.4;
			float niveau_perturbations_ondes_0=1.5;
			float facteur_perturbation_octave_0=.5;
			...
			float echelle_texture_ocean=40000.;
			float intensite_deplacement_texture=1000.;
			...
			couleur_ocean =couleur_ocean_perturbe*0.25+couleur_ocean*0.75;
